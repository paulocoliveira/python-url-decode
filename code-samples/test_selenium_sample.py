...
@pytest.mark.parametrize("url, expected_decoded_url", [
    ...
    ("https://www.lambdatest.com/selenium-playground/simple-form-demo?my%20message=Minimum%20lib%20versions%20to%20run%20these%20codes%20are%20selenium%3E%3D4.11.2%2C%20requests%3E%3D2.31.0%2C%20and%20pytest%3E%3D7.4.3", "https://www.lambdatest.com/selenium-playground/simple-form-demo?my message=Minimum lib versions to run these codes are selenium>=4.11.2, requests>=2.31.0, and pytest>=7.4.3"),
    ("https://www.lambdatest.com/selenium-playground/simple-form-demo?my%20message=We%20can%20run%20all%20these%20tests%20in%20parallel%20using%20pytest-xdist", "https://www.lambdatest.com/selenium-playground/simple-form-demo?my message=We can run all these tests in parallel using pytest-xdist")
])
